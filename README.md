...
<pre>curl -L https://meshery.io/install | bash -<button>Click me</button><i class="fa-regular fa-copy"></i><i class="fa-light fa-copy"></i></pre><i class="fa-regular fa-copy"></i><i class="fa-light fa-copy"></i>
